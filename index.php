                            ...
                            <div class="row">
                              <div class="col-lg-12 col-12">
                                <div class="small-box bg-info">
                                  <div class="inner">
                                    <h3>Registrar</h3>
                                    <p> Aquí tambien encontraras el listado de personas </p>
                                  </div>
                                  <div class="icon">
                                    <i class="ion ion-person"></i>
                                  </div>
                                  <a href="pages/products/list.php" class="small-box-footer">Has click aquí <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                              </div>
                            </div>
                          </div>
